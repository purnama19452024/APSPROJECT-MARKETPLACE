    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Pengembalian Barang</h1>
                <p class="text-sm text-gray-500 mb-6">Kelola permintaan return dari pelanggan</p>
                            ...
                            @forelse($returns as $r)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-3 text-center">
                                        <a href="{{ route('admin.returns.show', $r) }}" class="text-blue-600 hover:text-blue-700 bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg text-xs font-medium inline-flex items-center gap-1"><i class="fas fa-eye"></i> Detail</a>
                                    </td>
                                </tr>
                            @empty
                                <tr><td colspan="6" class="p-10 text-center text-gray-400">
                                    <i class="fas fa-undo-alt text-4xl mb-3"></i>
                                    <p class="font-medium">Belum ada permintaan pengembalian</p>
                                </td></tr>
                            @endforelse
                        </tbody>
                    </table>
