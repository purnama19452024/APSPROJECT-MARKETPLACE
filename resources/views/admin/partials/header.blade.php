    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <div class="flex items-center space-x-2 text-sm">
                <img src="{{ auth()->user()->photo_url }}" alt="" class="w-8 h-8 rounded-full object-cover cursor-pointer hover:ring-2 hover:ring-orange-300 transition" onclick="openImagePreview('{{ auth()->user()->photo_url }}', '{{ auth()->user()->name }}')">
