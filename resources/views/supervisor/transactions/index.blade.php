...
<head>
    ...
    <title>Transaksi - Supervisor</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <h1 class="text-xl font-bold text-gray-800 mb-4">Data Transaksi</h1>
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-3">
                                        <span class="px-2 py-0.5 rounded-full text-xs font-medium
                                            ...
                                            @else bg-red-100 text-red-700 @endif">{{ $t->status }}</td>
                                    <td class="p-3 text-gray-500">{{ $t->created_at->format('d/m/Y') }}</td>
                                    <td class="p-3"><a href="{{ route('supervisor.transactions.show', $t) }}" class="text-blue-500 hover:text-blue-600"><i class="fas fa-eye"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
